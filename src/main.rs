...
fn insert_node(id: &String, label: &str, graph: &mut Vec<String>) {
    graph.push(format!("{} [label=\"{}\"];", id, label));
}

fn insert_edge(a: &String, b: &String, graph: &mut Vec<String>) {
    graph.push(format!("{} -- {};", a, b));
}
